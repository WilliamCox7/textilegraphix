...
class ProductBuilder extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      product: props.builder.product,
      selectedColor: props.builder.product.colors[0].name,
      selectedHex: props.builder.product.colors[0].hex,
      quantity: 1,
      frontColors: 0,
      backColors: 0,
      sleeveColors: 0,
    ...
    this.updateOrderInCart = this.updateOrderInCart.bind(this);
  ...
  render() {
    ...
    let colors = this.props.builder.product.colors.map((color, i) => {
      ...
      <div className="ProductBuilder">
        <div className="product-builder-wrapper">
          <MediaQuery className="top-bar flex jc-sb ai-c" minWidth={1200}>
            <h1 className="fs-24 c-white fw-bold">{this.props.builder.product.brand} {this.props.builder.product.number}</h1>
            <span className="close-button"><img src={getAsset('close-x-white')} onClick={this.props.closeBuilder} /></span>
            <div className="right-buttons flex">
              ...
              {this.props.builder.edit ? (
                <button className="fs-15 fw-bold c-white add-button" onClick={this.updateOrderInCart}>SAVE ORDER</button>
              ) : (
                ...
                <div className="step" style={this.state.addOns ? null : {"borderBottom": "solid 1px #D1D1D1"}}>
                  ...
                  <div className="content-wrapper flex">
                    ...
                    <div className="content sizing-wrapper flex">
                      <SizingForm order={this.state} updSizing={this.updSizing} optionalText={true} id={'product-builder'} />
        ...
        <div className="gray-overlay" onClick={this.props.closeBuilder}></div>
      </div>
    );
  }
}
...
ProductBuilder.prototype.updateOrderInCart = method.updateOrderInCart;
