  ...
  return (
    <div className="ProductModal">
      ...
      <div className="modal">
          ...
          <div className="locations">
            <div className="location">
              ...
              <div className="radio-button">
                ...
                (radioEmpty)} onClick={() => ProductModal.updTitles('front')} /> Front
              </div>
              <div className="radio-button">
                <img src={ProductModal.props.product.back ? (radioFilled):
                (radioEmpty)} onClick={() => ProductModal.updTitles('back')} /> Back
              </div>
              <div className="radio-button">
                <img src={ProductModal.props.product.bottom ? (radioFilled):
                (radioEmpty)} onClick={() => ProductModal.updTitles('bottom')} /> Bottom
              </div>
              <div className="radio-button">
                <img src={ProductModal.props.product.leftSleeve ? (radioFilled):
                (radioEmpty)} onClick={() => ProductModal.updTitles('leftSleeve')} /> Left Sleeve
              </div>
              <div className="radio-button">
                <img src={ProductModal.props.product.rightSleeve ? (radioFilled):
                (radioEmpty)} onClick={() => ProductModal.updTitles('rightSleeve')} /> Right Sleeve
              </div>
            </div>
        ...
        <div className="column">
          <Mockup product={ProductModal.props.product} edit={true} />
